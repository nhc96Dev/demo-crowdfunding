...
const Payment = () => {
  return (
    <div className="flex gap-x-15px lg:gap-x-30px">
      <div className="w-[100px] h-[76px] lg:w-[132px] lg:h-[102px] shadow-2 rounded-15 bg-white flex flex-col justify-center items-center border border-primary relative">
        <img
      ...
      <div className="w-[100px] h-[76px] lg:w-[132px] lg:h-[102px] shadow-2 rounded-15 bg-white flex flex-col justify-center items-center py-6 px-10">
        <img
